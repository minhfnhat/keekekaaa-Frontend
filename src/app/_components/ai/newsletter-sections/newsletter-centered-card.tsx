    ...
    <div className={`py-16 sm:py-24`}>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Stay informed with life hacks, productivity tips, and industry insights delivered straight to your inbox. Our newsletter is designed to help you find harmony in your work and personal life.
          </p>
